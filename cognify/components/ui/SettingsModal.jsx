  ...
  return (
    ...
    >
      <div className="modal">
        ...
        {settingsError && (
          <div className="err" style={{ marginBottom: 10 }}>⚠ {settingsError}</div>
        )}

        <div className="row" style={{ gap: 10 }}>
          <button className="btn btn-p" style={{ flex: 1 }} onClick={onSave}>
            Save New Key
          </button>
          <button className="btn btn-r" style={{ flex: 1 }} onClick={onDelete}>
            Remove Key
          </button>
        </div>
      </div>
